...
// middlewares
app.use(cors({
    origin: ['http://localhost:5173', 'cars-doctor-9063d.web.app'],
    credentials: true
}))
...
const logger = async (req, res, next) => {
    console.log('custom middleware called : ', req.host, req.originalUrl, req.method)
    next();
}
...
async function run() {
    try {
        ...
        app.get('/bookings', logger, verifyToken, async (req, res) => {
            console.log('tokens are here', req.cookies.token);
